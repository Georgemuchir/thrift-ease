...
const NewWomen = () => {
  ...
  const subcategories = [
    "Dresses", "Tops", "Jeans", "Skirts", "Activewear", "Coats & Jackets"
  ];
  ...
  const fetchProducts = async () => {
    try {
      setLoading(true);
      const data = await productsAPI.fetchProductsByCategory('women');
      setProducts(data);
    } catch (error) {
      ...
      <div className="container">
        ...
        <div className="page-header">
          <div className="page-title-section">
            ...
            <p>Discover amazing thrift finds in women's clothing</p>
          </div>
